...
set_property  -dict {PACKAGE_PIN  D22  IOSTANDARD LVCMOS25} [get_ports data_bd[2]]    ; ## G27  FMC_LPC_LA25_P
set_property  -dict {PACKAGE_PIN  C22  IOSTANDARD LVCMOS25} [get_ports data_bd[3]]    ; ## G28  FMC_LPC_LA25_N
...
set_property  -dict {PACKAGE_PIN  G20  IOSTANDARD LVCMOS25} [get_ports data_bd[8]]    ; ## G21  FMC_LPC_LA20_P
set_property  -dict {PACKAGE_PIN  G21  IOSTANDARD LVCMOS25} [get_ports data_bd[9]]    ; ## G22  FMC_LPC_LA20_N
set_property  -dict {PACKAGE_PIN  G19  IOSTANDARD LVCMOS25} [get_ports data_bd[10]]   ; ## G24  FMC_LPC_LA22_P
set_property  -dict {PACKAGE_PIN  F19  IOSTANDARD LVCMOS25} [get_ports data_bd[11]]   ; ## G25  FMC_LPC_LA22_N
set_property  -dict {PACKAGE_PIN  G15  IOSTANDARD LVCMOS25} [get_ports data_bd[12]]   ; ## H22  FMC_LPC_LA19_P
set_property  -dict {PACKAGE_PIN  G16  IOSTANDARD LVCMOS25} [get_ports data_bd[13]]   ; ## H23  FMC_LPC_LA19_N
...
set_property  -dict {PACKAGE_PIN  K19  IOSTANDARD LVCMOS25} [get_ports rxd[10]]       ; ## C18  FMC_LPC_LA14_P
set_property  -dict {PACKAGE_PIN  K20  IOSTANDARD LVCMOS25} [get_ports rxd[11]]       ; ## C19  FMC_LPC_LA14_N

set_property  -dict {PACKAGE_PIN  N19  IOSTANDARD LVCMOS25} [get_ports tx_clk]        ; ## D08  FMC_LPC_LA01_CC_P
set_property  -dict {PACKAGE_PIN  M17  IOSTANDARD LVCMOS25} [get_ports txiq]          ; ## D18  FMC_LPC_LA13_N
...
set_property  -dict {PACKAGE_PIN  L21  IOSTANDARD LVCMOS25} [get_ports txd[8]]        ; ## C10  FMC_LPC_LA06_P
set_property  -dict {PACKAGE_PIN  L22  IOSTANDARD LVCMOS25} [get_ports txd[9]]        ; ## C11  FMC_LPC_LA06_N
set_property  -dict {PACKAGE_PIN  R19  IOSTANDARD LVCMOS25} [get_ports txd[10]]       ; ## C14  FMC_LPC_LA10_P
set_property  -dict {PACKAGE_PIN  T19  IOSTANDARD LVCMOS25} [get_ports txd[11]]       ; ## C15  FMC_LPC_LA10_N

set_property  -dict {PACKAGE_PIN  A18  IOSTANDARD LVCMOS25 PULLTYPE PULLUP} [get_ports iic_m2k_fmc_sda];    ## H28  FMC_LPC_LA24_P
set_property  -dict {PACKAGE_PIN  A19  IOSTANDARD LVCMOS25 PULLTYPE PULLUP} [get_ports iic_m2k_fmc_scl];    ## H29  FMC_LPC_LA24_N
