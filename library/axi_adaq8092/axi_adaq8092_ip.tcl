...
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name my_ila
    ...
    set_property -dict [list CONFIG.C_NUM_OF_PROBES {16}] [get_ips my_ila]
    ...
    set_property -dict [list CONFIG.C_PROBE14_WIDTH {28}] [get_ips my_ila]
...
set_property company_url {https://wiki.analog.com/resources/fpga/docs/axi_adaq8092} [ipx::current_core]
